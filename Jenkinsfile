node {
  ...
  stage('SonarQube Analysis') {
    timeout(time: 10, unit: 'MINUTES') {
      ...
      withSonarQubeEnv() {
        sh "/var/jenkins_home/tools/io.jenkins.plugins.dotnet.DotNetSDK/dotnet_8_linux/dotnet ${scannerHome}/SonarScanner.MSBuild.dll begin /k:\"olih-api\" -Dsonar.coverageReportPaths=coverage.cobertura.xml"
